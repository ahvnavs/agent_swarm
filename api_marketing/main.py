...
app = FastAPI(title="Marketing Mock API") # type: ignore
class MarketingData(BaseModel): # type: ignore
    campaign_id: str
    campaign_name: str
    ad_spend: float
    impressions: int
...
@app.get("/marketing", response_model=List[MarketingData]) # type: ignore
